...
ax.plot(df_distance.index, df_distance.iloc[:,2], color = 'black', linestyle = '-', label = 'Not Sold')
ax.plot(df_distance.index, df_distance.iloc[:,3], color = 'black', linestyle = '--', label = 'Sold')
ax.axvspan(2007,2009, alpha = 0.5, color = 'lightgray')
ax.set_xlim(2004, 2019)
#ax.legend()
plt.tight_layout()

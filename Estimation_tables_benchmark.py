...
# Set path list
path_list = ['Results/Distance_results_benchmark.csv',\
             'Results/Distance_results_benchmark_1019.csv']
...
df_results.to_csv('Results/Table_results_distance.csv')

text_file_latex_results = open('Results/Table_results_distance.tex', 'w')

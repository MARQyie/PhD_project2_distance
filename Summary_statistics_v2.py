...
# prelims
vars_needed = ['log_min_distance', 'log_min_distance_cdd','min_distance', 'min_distance_cdd', 'ls_num', \
...
df['min_distance'] = np.exp(df.log_min_distance) - 1
df['min_distance_cdd'] = np.exp(df.log_min_distance_cdd) - 1
